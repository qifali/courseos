...
export class CourseService {
    ...
    buildQueryParamter(req?:any){
        if(req) {
            const courseQuery = req.courseQuery;
            if (courseQuery) {
                if (courseQuery.courseCode) {
                    req['courseCode.equals'] = courseQuery.courseCode;
                }
                if (courseQuery.name) {
                    req['name.contains'] = courseQuery.name;
                }
                if (courseQuery.grade) {
                    req['grade.equals'] = courseQuery.grade;
                }
            }
        }
