    ...
    private Specifications<Course> createSpecification(CourseCriteria criteria) {
        ...
        if (criteria != null) {
            ...
            if (criteria.getDesc() != null) {
                specification = specification.and(buildStringSpecification(criteria.getDesc(), Course_.desc));
            }
            if (criteria.getGrade() != null) {
                specification = specification.and(buildStringSpecification(criteria.getGrade(), Course_.grade));
            }
        }
